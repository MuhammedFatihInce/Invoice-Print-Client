...
namespace partsSoftClient
{
	partial class Part_Soft
	{
		...
		private void InitializeComponent()
		{
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "Fatura Geçmişi";
			...
			this.Name = "Part_Soft";
			this.Text = "Part_Soft";
			//this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Part_Soft_FormClosing);
			this.Load += new System.EventHandler(this.Part_Soft_Load);
			this.Resize += new System.EventHandler(this.Part_Soft_Resize);
